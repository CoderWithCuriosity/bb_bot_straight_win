...
async function countFinishedMatches(useCurrentHour = false) {
  ...
  console.log(`Draws with less than 3.0 Odds : ${draws_l_odds}`);
  console.log(`Draws with no less than 3.0 Odds : ${no_draws_odds}`);
  console.log(`Matches with less than 3.0 odds ${l_odds}`);
  console.log(`Matches with more than or equal 3.0 odds ${m_odds}`)
